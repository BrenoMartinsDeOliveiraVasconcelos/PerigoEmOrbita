...
draw_text((global.PLANET.x-fontTextSize/2), global.PLANET.y, hpText)
draw_text(global.DRAW_SPACING, get_drawy_position(3, global.DRAW_SPACING), "U"+string(global.UPGRADE_ROCKET.upgrade_time)+"/"+string(global.UPGRADE_ROCKET.upgrade_time_max))
